...
% Abstract
%-----------------------------------
\input{chapter/introduction/abstract}
...
\newcounter{apxnumber}
\newcommand{\apxtitle}[1]{\stepcounter{apxnumber}\textbf{\large Appendix \Roman{apxnumber}: #1}}
...
\begin{appendix}
	...
	\renewcommand{\thesection}{\AppendixName\ \arabic{section}} %Can't make it Roman or even delete it otherwise all sections end with '.' I have no idea why
