\subsection{Full-Text Search}\label{sec:fulltext}
...
\begin{mycapequ}[H]
    \caption{Weighted Harmonic Mean}
    \label{form:whmean}
    \begin{tcolorbox}[ams equation]
...
\subsubsection{SQL Server Search Architecture}
